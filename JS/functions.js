...
$(function () {
	...
	(function (con) {
      ...
      con.LoadDoHoaVong4 = function(x) {
        ...
        $('#qc-3 .row_cell_arrow').css({'width':(35 / x) + 'vw', 'height':(32 / x) + 'vw', 'font-size' : (4.5 - Math.abs(4 - x) * 0.2) + 'vw'})
        $('#qc-2 .row_cell, #qc-2 .row_crown, #qc-2 .row_cell_x, #qc-2 .row_cell_high, #qc-2 .row_cell_high_x').css({'width':(32 / x) / 2.5 + 'vw', 'height':(32 / x) + 'vw', 'font-size' : ((4.85 - Math.abs(4 - x) * 0.5) / 2.5) + 'vw'})
